...
(function($) {
  ...
  $(function() {
    ...
    $(document).ready(function() {
      ...
      $(".nav-link").removeClass("active"); // remove active class from all links in the nav
    
      $(".nav-link[href='" + currentUrl + "']").addClass("active"); // add active class to the link with the current URL in the nav
    });
