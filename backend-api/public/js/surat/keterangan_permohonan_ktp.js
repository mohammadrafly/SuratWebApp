...
function edit(id) {
    ...
    $.ajax({
        ...
        success: function(respond) {
            const { author, nama, nik, jenis_kelamin, ttl, agama, status_perkawinan, pekerjaan, kewarganegaraan, status_ttd, disposisi_surat } = respond;
...
function save() {
    const id = $('#id').val();
    const url = id ? `${base_url}${apiUrl}keterangan-permohonan-ktp/${id}` : `${base_url}${apiUrl}pengantar-nikah`;
